...
def Teams_Season_Analysis_main():
        
    # Streamlit Page Title
    st.title("Season Analysis: Team Performance")
    ...
    st.write(f"## Team Analysis: {selected_stat.title()} Across Rounds (games {selected_season})")
